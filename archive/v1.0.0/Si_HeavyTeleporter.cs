...
[assembly: MelonInfo(typeof(Si_HeavyTeleporter.HeavyTeleporter), "Heavy Teleporter", "1.0.0", "schwe")]
...
namespace Si_HeavyTeleporter
{
    public class HeavyTeleporter : MelonMod
    {
        ...
        public override void OnInitializeMelon()
        {
            ...
            LoadConfig();
            MelonLogger.Msg("Heavy Teleporter v1.0.0 loaded! (Sol + Centauri)");
        ...
        void UpdateTeams()
        {
            ...
            for (int i = 0; i < Player.Players.Count; i++)
            {
                ...
                break; // only need one player per team to trigger updates
            }
        }
